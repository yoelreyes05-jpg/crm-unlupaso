import type { Frecuencia, Metodo, ModoReparto, Prorrateo } from "@/lib/anyeli/calculo";

export type { Frecuencia, Metodo, ModoReparto, Prorrateo };

/** Tablas ia_* del módulo de Préstamos. */
...
/** Vista ia_v_ganancias_mensuales */
