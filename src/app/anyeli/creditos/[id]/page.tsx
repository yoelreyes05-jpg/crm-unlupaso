...
import type { PrConfig, PrCuotaVista, PrPago, PrPrestamoVista, PrReenganche } from "@/types/anyeli";
          ...
          <div>
            ...
            <div style={{ marginTop: 2 }}>
              ...
              {p.inversionista_nombre
                ? <Link href={`/anyeli/inversionistas/${p.inversionista_id}`} style={{ color: T.acento }}>{p.inversionista_nombre}</Link>
                : "capital propio"}
            ...
            <Tabla
              ...
              acciones={(f) => (
                <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", alignItems: "center" }}>
                  <Link
                    href={`/anyeli/creditos/${id}/recibo/${f.id}`}
            ...
            try {
              ...
              setOk(
                <>
                  ...
                  {nuevo && (
                    <Link
                      href={`/anyeli/creditos/${id}/recibo/${nuevo.id}`}
