...
import { CajaInversionista } from "@/components/anyeli/CajaInversionista";
import type { PrInversionistaVista } from "@/types/anyeli";
...
const columnas: Columna[] = [
  ...
  { name: "nombre", label: "Inversionista",
    fmt: (v, f) => (
      <Link href={`/anyeli/inversionistas/${f.id}`} style={{ color: T.texto, fontWeight: 700, textDecoration: "none" }}>
        {String(v)}
      </Link>
    ) },
