...
import { listar, fail } from "@/lib/prestamos/crud";
import { PRESTAMOS_VISTA } from "@/lib/prestamos/tablas";
import { crearPrestamo, type DatosNuevoPrestamo } from "@/lib/prestamos/motor";

/**
 * GET  → lista desde la vista pr_v_prestamos (con saldos y estado calculado)
