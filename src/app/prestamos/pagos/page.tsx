...
import type { PrPago, PrPrestamoVista } from "@/types/prestamos";
          ...
          <Tabla
            columnas={[
              ...
              { name: "cuota_id", label: "Préstamo",
                fmt: (_v, f) => (
                  <Link href={`/prestamos/creditos/${f.prestamo_id}`} style={{ color: T.acento, fontSize: 12, textDecoration: "none" }}>
